...
/// </summary>
public sealed class GigaChatAIChatCompletionService : IChatCompletionService
{
    /// <summary>
    /// Initializes a new instance of the <see cref="GigaChatAIChatCompletionService"/> class.
    /// </summary>
    ...
    public GigaChatAIChatCompletionService(string modelId, string apiKey, Uri? endpoint = null, HttpClient? httpClient = null, ILoggerFactory? loggerFactory = null)
    {
    ...
    private GigaChatClient Client { get; }
    #endregion
}
