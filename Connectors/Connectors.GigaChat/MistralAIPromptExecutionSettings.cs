...
public sealed class GigaChatAIPromptExecutionSettings : PromptExecutionSettings
{
    /// <summary>
    /// Default: 0.7
    ...
    {
        return new GigaChatAIPromptExecutionSettings()
        {
    ...
    public static GigaChatAIPromptExecutionSettings FromExecutionSettings(PromptExecutionSettings? executionSettings)
    {
        ...
        if (executionSettings is GigaChatAIPromptExecutionSettings settings)
        {
            return settings;
        }
        ...
        var mistralExecutionSettings = JsonSerializer.Deserialize<GigaChatAIPromptExecutionSettings>(json, JsonOptionsCache.ReadPermissive);
